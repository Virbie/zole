    let playerGajienaID = 1  // Gajiens apzime vai paslaik ir tavs gajiens
...
function GajienaUzvaretajs(value){
    ...
    if(foundArrayName == trumpe){
        ...
        GajienaUzvaretajsPlayer = lielakaisI+1
