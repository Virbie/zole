...
function Karsudalisana(){
    ...
    document.getElementById("Visaskartis").innerHTML = kartis.toString();
    document.getElementById("Player1kartis").innerHTML = player1.toString();
    document.getElementById("Player2kartis").innerHTML = player2.toString();
    document.getElementById("Player3kartis").innerHTML = player3.toString();
